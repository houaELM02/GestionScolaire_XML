                    ...
                    <fo:table-cell width="3.8cm" height="12cm" border="solid">
                        ...
                        <fo:block>
                            <fo:block width="1.5cm"
                                ...
                                <fo:instream-foreign-object margin-left="-4cm">
                                    <svg width="175" height="130" viewBox="0 0 98 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect x="-0.09772" y="0.985062" width="95.4644" height="52.8319" rx="11.5" fill="#03EA68" stroke="black"/>
                                        <line x1="1.52698" y1="11.1227" x2="95.1328" y2="11.1227" stroke="black"/>
                                    </svg>
                            ...
                            <fo:block width="0.5cm"
                                ...
                                <fo:table margin-left="-0.98cm" width="3.6cm" border-collapse="separate"  >
                                    ...
                                    <fo:table-header  >
                                        <fo:table-cell >
                                            <fo:block font-size="15px">
                                                <xsl:value-of select="e:matieres/e:matiere61/e:type"/>
                                                <xsl:value-of select="e:matieres/e:matiere61/e:Durre1"/>
                                                <!--Cour - HDep - Hfin-->
                                            </fo:block>
                                        </fo:table-cell>
                                    </fo:table-header>
                                    ...
                                    <fo:table-body>
                                        <fo:table-cell >
                                            <fo:block font-size="15px" margin-top="0.1cm" width="3.6cm" margin-left="-0.2cm">
                                                <xsl:value-of select="e:matieres/e:matiere61/e:nom"/>
                                                <!--Matière-->
                                            </fo:block>
                                            <fo:block font-size="18px" text-align="center" margin-left="-0.5cm">
                                                <xsl:value-of select="e:matieres/e:matiere61/e:nomProf"/>
                                                <!--PROF-->
                                            </fo:block>
                                            <fo:block font-size="18px" text-align="center" margin-left="-0.3cm">
                                                <xsl:value-of select="e:matieres/e:matiere61/e:salle"/>
                                                <!--Salle-->
                                            </fo:block>
                                        </fo:table-cell>
                                    </fo:table-body>
                        ...
                        <fo:block width="0.5cm"
                            ...
                            <fo:table margin-left="-0.98cm" width="3.6cm" border-collapse="separate"  >
                                ...
                                <fo:table-header  >
                                    <fo:table-cell >
                                        <fo:block font-size="15px">
                                            <xsl:value-of select="e:matieres/e:matiere71/e:type"/>
                                            <xsl:value-of select="e:matieres/e:matiere71/e:Durre1"/>
                                            <!--Cour - HDep - Hfin-->
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-header>
                                ...
                                <fo:table-body>
                                    <fo:table-cell >
                                        <fo:block font-size="16px" text-align="center" margin-top="0.1cm" width="3.6cm" margin-left="-0.1cm">
                                            <xsl:value-of select="e:matieres/e:matiere71/e:nom"/>
                                            <!--Matière-->
                                        </fo:block>
                                        <fo:block font-size="18px" text-align="center" margin-left="-0.5cm">
                                            <xsl:value-of select="e:matieres/e:matiere71/e:nomProf"/>
                                            <!--PROF-->
                                        </fo:block>
                                        <fo:block font-size="18px" text-align="center" margin-left="-0.3cm">
                                            <xsl:value-of select="e:matieres/e:matiere71/e:salle"/>
                                            <!--Salle-->
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-body>
                    ...
                    <fo:table-cell width="3.8cm" height="12cm" border="solid">
                        ...
                        <fo:block>
                            <fo:block width="1.5cm"
                                ...
                                <fo:instream-foreign-object margin-left="-4cm">
                                    <svg width="175" height="130" viewBox="0 0 98 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect x="-0.09772" y="0.985062" width="95.4644" height="56.8319" rx="11.5" fill="#C17FE9" stroke="black"/>
                                        <line x1="1.52698" y1="11.1227" x2="95.1328" y2="11.1227" stroke="black"/>
                                    </svg>
                        ...
                        <fo:block>
                            ...
                            <fo:block width="0.5cm"
                                ...
                                <fo:table margin-left="-0.98cm" width="3.6cm" border-collapse="separate"  >
                                    ...
                                    <fo:table-body>
                                        <fo:table-cell >
                                            <fo:block font-size="15px" margin-top="0.1cm" width="3.6cm" margin-left="-0.2cm" text-align="center">
                    ...
                    <fo:table-cell width="3.8cm" height="12cm" border="solid">
                        ...
                        <fo:block>
                            ...
                            <fo:block width="0.5cm"
                                ...
                                <fo:table margin-left="-0.98cm" width="3.6cm" border-collapse="separate"  >
                                    ...
                                    <fo:table-body>
                                        <fo:table-cell >
                                            <fo:block font-size="16px" margin-top="0.1cm" width="3.6cm" margin-left="-0.1cm" text-align="center">
                        ...
                        <fo:block>
                            <fo:block width="1.5cm"
                                ...
                                <fo:instream-foreign-object margin-left="-4cm">
                                    <svg width="175" height="130" viewBox="0 0 98 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect x="-0.09772" y="0.985062" width="95.4644" height="56.8319" rx="11.5" fill="#03EA68" stroke="black"/>
                                        <line x1="1.52698" y1="11.1227" x2="95.1328" y2="11.1227" stroke="black"/>
                                    </svg>
                        ...
                        <fo:block>
                            ...
                            <fo:block width="0.5cm"
                                ...
                                <fo:table margin-left="-0.98cm" width="3.6cm" border-collapse="separate"  >
                                    ...
                                    <fo:table-body>
                                        <fo:table-cell >
                                            <fo:block font-size="16px" margin-top="0.1cm" width="3.6cm" margin-left="-0.2cm" text-align="center">
                            ...
                            <fo:table-row>
                                ...
                                <fo:table-cell width="4cm" >
                                    <fo:block margin-top="1cm" margin-left="4cm">
                                        <fo:instream-foreign-object>
                                            <svg width="85" height="37" viewBox="0 0 80 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect x="0.5" y="0.5" width="79" height="28" fill="#03EA68" stroke="black"/>
                                            </svg>
                                        </fo:instream-foreign-object>
                                    </fo:block>
