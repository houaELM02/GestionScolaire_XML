...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    xmlns:c="http://CarteEtudiant.org"
    xmlns:xs="http://www.w3.org/2001/XMLSchema"
    exclude-result-prefixes="xs"
    version="1.0">

    <xsl:template match="c:cards">
                ...
                <!-- TOP BAR -->    
                    ...
                    <fo:table table-layout="fixed">
                        ...
                        <fo:table-body>
                            <fo:table-row>
                                <fo:table-cell  >
                                    <fo:block width="6.3cm"  margin-top="-0.05cm" font-family="Roboto"
                        ...
                        <fo:table-body>
                            <fo:table-row>
                                <fo:table-cell width="1.3cm" >
                                    <xsl:if test="c:Etudiant/c:photo">
                                ...
                                <fo:table-cell width="2.9cm" height="1cm">
                                    <fo:block font-family="Roboto" font-size="9px" color="#02306E" margin-left="0.2cm" margin-top="0.5cm" margin-bottom="0.04cm">
                                        <xsl:value-of select="c:Etudiant/c:lastName"/>
                                    </fo:block>
                                    <fo:block font-family="Roboto" font-size="9px" color="#02306E"  margin-left="0.2cm"  margin-bottom="0.04cm">
                                        <xsl:value-of select="c:Etudiant/c:firstName"/>
                                    </fo:block>
                                    <fo:block font-family="Roboto" font-size="9px" color="#02306E"   margin-left="0.2cm" margin-bottom="0.04cm">
                                        <xsl:value-of select="c:Etudiant/c:codeApoge"/>
                                    </fo:block>
                                </fo:table-cell>
                                
                                <fo:table-cell width="1.3cm" >
                                    <xsl:if test="c:Etudiant/c:scanBar" >
                                        <fo:block margin-left="0.4cm" margin-top="0.1cm">
                                            <fo:external-graphic 
                                                src="codeQr.png"
                                                content-height="scale-to-fit"
                                                content-width="scale-to-fit"
                                ...
                                <fo:table table-layout="fixed">
                                    ...
                                    <fo:table-body>
                                        <fo:table-row>
                                            <fo:table-cell  >
                                                <fo:block width="6.3cm"  margin-top="0cm" font-family="Roboto"
                                                    font-weight="200"
                                                    font-size="10px" color="#02306E" 
                                                    margin-left="1.6cm">
                                                    <xsl:value-of select="c:footer"/>
                                                </fo:block>
                                            </fo:table-cell>
                                        </fo:table-row>
                                    </fo:table-body>
