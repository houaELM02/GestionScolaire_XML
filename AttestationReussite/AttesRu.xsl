...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="r:attestation">
        <fo:root>
                            ...
                            <fo:table-row>
                                <fo:table-cell width="8.5cm" height="3cm" margin-right="0.6cm">
                                    ...
                                    <fo:block font-family="Roboto" font-size="19px" color="#02306E" text-align="center"  margin-bottom="0.1cm">
                                        <xsl:value-of select="r:nomUaefr"/>
                                    </fo:block>
                                    <fo:block font-family="Roboto" font-size="19px" color="#02306E" text-align="center"  margin-bottom="0.1cm">
                                        <xsl:value-of select="r:nomEcolefr"/>
                                    </fo:block>
                                    <fo:block font-family="Roboto" font-size="19px" color="#02306E" text-align="center"  margin-bottom="0.1cm">
                                        <xsl:value-of select="r:villefr"/>
                                    </fo:block>
                                ...
                                <fo:table-cell width="9.5cm" height="3cm" margin-right="-1.2cm">
                                    ...
                                    <fo:block font-family="Arial" font-size="24px"
                                        ...
                                        >
                                        <xsl:value-of select="r:nomUaeAr"/>
                                    </fo:block>
                                    <fo:block font-family="Arial" font-size="24px"
                                        color="#02306E" text-align="center"  margin-bottom="0.03cm" 
                                        >
                                        <xsl:value-of select="r:nomEcoleAr"/>
                                    </fo:block>
                                    <fo:block font-family="Arial" font-size="24px"
                                        color="#02306E" text-align="center" margin-bottom="-0.15cm"  
                                        >
                                        <xsl:value-of select="r:villeAr"/>
                                    </fo:block>
                            ...
                            <fo:table-row>
                                <fo:table-cell  >
                                    ...
                                    <fo:block font-family="Arial" font-size="24px"
                                        ...
                                        <fo:inline> </fo:inline> <!-- Ajout d'un espace -->
                                        <xsl:value-of select="r:body/r:infoEtudiant/r:mention"/>
                                    </fo:block>
